...
const PlansCard = (props) => {
  const features = [
    "Sesiones diarias gratuitas con un entrenador personal.",
    "Acceso a las instalaciones del gimnasio durante el horario de operación.",
    "Acceso a todas las habitaciones.",
    "Uso de equipos de gimnasio avanzados.",
  ];
  ...
  return (
    <div className="flex flex-col bg-gray-950 w-full md:w-1/3 p-8 rounded-xl shadow-lg">
      ...
      <div className="flex items-center justify-center">
        <MdOutlineAttachMoney className="text-white mr-2" size={25} />
